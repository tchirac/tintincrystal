...
.String_PlayersPC:  db "<PLAYER>ades/@"
.String_BillsPC:    db "#S pro/@"
.String_OaksPC:     db "Slack.exe@"
.String_HallOfFame: db "Publis/@"
.String_TurnOff:    db "ETEINDRE@"
