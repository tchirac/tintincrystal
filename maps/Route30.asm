...
YoungsterJoey1AfterText:
	text "Ai-je vraiment"
	line "besoin d'autres"

	para "arguments quand"
	line "un seul suffit?"

	para "Non! Je reste"
	line "campé sur cette"
	cont "position!"
	done
...
BugCatcherDonSeenText:
	text "Vous iriez bien"
	line "dans mon papier"
	cont "sur les singes!"
	done
...
Route30YoungsterText_EveryoneIsBattling:
	...
	para "mais si vous me"
	line "demandez mon avis"
	cont "je vous le donne."
	done
